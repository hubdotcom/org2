package org.owasp.org2host.shared.model.managers
{
	...
	import org.owasp.org2host.shared.model.vos.ModuleDescriptor;
	...
	public class PermissionsManager extends EventDispatcher
	{
		...
		public function setPermissions( user:User ):void
		{
			...
			//_modulesAllowed.push( new ModuleDescriptor( "Start Page", "org/owasp/org2host/startpage/StartPage.swf", UserPermissions.READ_WRITE.permission ) );
